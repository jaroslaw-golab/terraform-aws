...
server {
    limit_req zone=beaconcure burst=36 nodelay;
        ...
        listen [::]:80 default_server;
        server_name verify-pf-training.beaconcure.com;
    ...
    location / {
      ...
      add_header "Access-Control-Allow-Origin" "https://verify-pf-training.beaconcure.com,http://verify-pf-training.beaconcure.com";
